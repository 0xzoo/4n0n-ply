...
export const add4n0nStyles: Hono.CSSProperties = {
  flexGrow: 1,
  display: 'flex',
  flexDirection: 'column',
  justifyContent: 'center',
...
export const anonGradientStyles: Hono.CSSProperties = {
  backgroundImage: 'linear-gradient(135deg, rgb(255, 124, 240), rgb(250, 255, 0))',
  backgroundClip: 'text',
  '-webkit-background-clip': 'text',
  color: 'transparent',
...
export const replyAnonStyles: Hono.CSSProperties = {
  flexGrow: 1,
  display: 'flex',
  flexDirection: 'column',
  justifyContent: 'center',
...
export const replyAnonErrorStyles: Hono.CSSProperties = {
  flexGrow: 1,
  display: 'flex',
  flexDirection: 'column',
  justifyContent: 'center',
...
export const errorTextContainerStyles = {
  display: 'flex',
  flexDirection: 'column',
  alignItems: 'center',
  justifyContent: 'center',
...
export const squareErrorFooterStyles = {
  // width: '1140px',
  height: '120px',
  display: 'flex',
  flexDirection: 'row',
